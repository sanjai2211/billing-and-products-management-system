...
import { FilterBillData, FilterCustomerData, SearchBillData, SearchCustomerData } from "@/lib/constants";
  ...
  return (
    <div className="flex items-center justify-between mx-2">
      <div className="flex flex-1 items-center space-x-2">
       <DynamicInputSearchField data={SearchCustomerData} form={form}/>
